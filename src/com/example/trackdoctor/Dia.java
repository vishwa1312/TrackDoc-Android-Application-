			...
			public void onClick(View v) {
				...
				if(age2 < 14)
				{
					if(days2 < 6)
					{
						...
						tab2.setText("with");
						tab3.setText("feed 1 teaspoon of ORS regularly for every 5 min");
					}
					else
				...
				else if((age2 > 14))
				{
					if(days2 < 6)
					{
						tab.setText("Eldoper      1-1-1 (or)");
						tab1.setText("Resdot       1-1-1 ");
						tab2.setText("with");
						tab3.setText("Drink 1 teaspoon of ORS regularly for every 5 min ");
					}
					else
						tab.setText("Better to Contact Doctor for Treatment");
				}
